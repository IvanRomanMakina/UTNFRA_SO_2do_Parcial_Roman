...
sudo useradd -m -g "2P_Supervisores" -d "/work/2P_202406_Supervisor" -p "$(sudo cat /etc/shadow | grep 2P_202406_Prog1 | awk -F: '{print$2}')" "2P_202406_Supervisor"
...
sudo chown "2P_202406_Supervisor:2P_Supervisores" "/work/2P_202406_Supervisor"
